...
const ENTRY_TEMP =  require('./fileTemplates/index.js.js')

const INDEX_TEMP = require('./fileTemplates/src-index.vue.js')

const EXAMPLE_TEMP = require('./fileTemplates/example-exam1.vue.js')
...
module.exports = (componentNames, option, userConfig) => {
  const env = option.env || 'dev'
  axios.get(userConfig[env].api).then(async (res) => {
